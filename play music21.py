...
file='C:/Users/chaitu/Desktop/songs/'

#############################################################################
#This code has been taken from https://gist.github.com/sloria/5693955 by sloria
r=Tkinter.Tk()
song=StringVar()
label=Label(r,text="Hii there! How are you doing ? Wanna listen some music?",fg="black",font='times 36')
label.pack()
search=Entry(r,textvariable=song,bg="beige",fg="purple",font='times 24')
search.pack()
...
def songs():
    ...
    class RecordingFile(object):
        ...
        def _prepare_file(self, fsongname, mode='wb'):
    ...
    def helpe(event=None):
        tkMessageBox.showinfo("Help','1.To open a file click on open and choose a file.To play a file click on play.Only .wav,.mp3,.ogg and .mid files can be played. Pause feature is available in .mp3,.ogg formats.To record sound go to file menu then Record option then give filename press save then start.Record and the press stop to stop recording")
    ...
    #nextsong=Tkinter.Button(banglakey, text=u'NEXT',command=nextsong,relief="groove",bg="#0060FF",fg="white",font=("arial",16))
    ...
    banglakey.mainloop()
    pygame.quit()
searchb=Button(r,text="search",command=songs)
searchb.pack()
r.mainloop()